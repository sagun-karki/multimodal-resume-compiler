    ...
    def write_resume(
        ...
        if previous_json and failing_bullets:
            edit_system_instruction = (
                ...
                "and suggest targeted atomic edits.\n"
                "3. Each edit must specify the JSON path (e.g., 'experience[0].bullets[2]' or 'skills.Languages[1]'), the original text, and the replacement text.\n"
